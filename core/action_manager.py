...
class ActionManager:
    ...
    TARIFFS = {
        "Краснодар": {
            "Зеленый": {"speed": "100 Мбит/с", "price": 100},
            "Желтый": {"speed": "200 Мбит/с", "price": 200},
            "Красный": {"speed": "300 Мбит/с", "price": 300}
        },
        "Станица Выселки": {
            "Аметист": {"speed": "100 Мбит/с", "price": 110},
            "Топаз": {"speed": "200 Мбит/с", "price": 220},
            "Брильянт": {"speed": "300 Мбит/с", "price": 330}
        }
    }
